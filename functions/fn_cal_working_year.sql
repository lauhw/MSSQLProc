...
select 
	...
	, dbo.fn_cal_working_year('2012-03-01', '2012-01-31')
	...
	, dbo.fn_cal_working_year('2012-03-01', '2012-12-31')as end2012	
...
*/
	...
	begin
		...
		set @days_to_dt2 = dbo.fn_day_count(dateadd(year, -1, @one_yr_old_dt) , @dt2)
		set @total_days_in_yr = dbo.fn_day_count(dateadd(year, -1, @one_yr_old_dt) , @one_yr_old_dt)
				
		set @yr_start = cast( 
								cast(year(@dt2) as nvarchar)
								+ '-01-01'
							as datetime)
